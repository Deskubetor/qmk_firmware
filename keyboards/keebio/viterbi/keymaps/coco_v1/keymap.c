 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |Adjust| Ctrl | GUI  | Alt  |Lower |Space |Space |      |Space |Space |Raise | Left | Down |  Up  | Right|
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY] = LAYOUT_ortho_5x14(
    ...
    KC_BSLS, KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,     KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_HOME, KC_END ,
    ADJUST , KC_LCTL, KC_LGUI, KC_LALT, LOWER  , KC_NO  , KC_SPC ,     KC_SPC , KC_NO  , RAISE  , KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT
  ),
 ...
 */
  [_LOWER] = LAYOUT_ortho_5x14(
    ...
    _______, _______, _______, _______, _______, _______, _______,     KC_MPLY, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MUTE
  ),
